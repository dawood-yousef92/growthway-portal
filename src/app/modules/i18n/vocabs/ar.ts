...
export const locale = {
  ...
  data: {
    ...
    INPUT: {
      ...
      VOLUME_UNIT_OF_MEASUR: 'وحدة القياسات لحجم الوحدة',
    ...
    TITLE: {
      ...
      BRANCH: 'الفرع',
      AWAIT_SELLER_APPROVAL: 'العروض الجديدة',
      PENDING_BUYER_APPROVAL: 'انتظار موافقة العميل',
      APPROVAL_BY_SELLER: 'العروض المقبولة',
      APPROVAL_BY_BUYER: 'تم التحويل لطلب شراء',
      REJECTED_BY_BUYER: 'مرفوض من قبل العميل',
      REJECTED_BY_SELLER: 'العروض الملغاة',
